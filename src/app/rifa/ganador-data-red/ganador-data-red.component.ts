...
@Component({
  selector: 'app-ganador-data-red',
  templateUrl: './ganador-data-red.component.html',
  styleUrls: ['./ganador-data-red.component.css'],
  animations: [textTrigger]
})
export class GanadorDataRedComponent implements OnInit {
