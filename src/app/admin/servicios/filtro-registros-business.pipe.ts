...
@Pipe({
  name: 'filtroRegistrosBusiness'
})
export class FiltroRegistrosBusinessPipe implements PipeTransform {

  transform(registros: Business[], busqueda_business: string, orden_business: string, asc_business: boolean): Business[] {
